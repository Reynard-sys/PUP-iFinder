          ...
          <form className="flex flex-col gap-5 sm:gap-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-x-10 lg:gap-x-16 gap-y-5 sm:gap-y-6">
              ...
              <div className="flex flex-col">
                <label htmlFor="name" className="text-sm sm:text-base font-normal text-[#8B0000] mb-2">
              ...
              <div className="flex flex-col">
                <label htmlFor="studentNumber" className="text-sm sm:text-base font-normal text-[#8B0000] mb-2">
                  Student Number
                </label>
                <input
                  id="studentNumber"
              ...
              <div className="flex flex-col">
                <label htmlFor="email" className="text-sm sm:text-base font-normal text-[#8B0000] mb-2">
                  Email Address
                </label>
                <input
                  id="email"
              ...
              <div className="flex flex-col">
                <label htmlFor="studentType" className="text-sm sm:text-base font-normal text-[#8B0000] mb-2">
                  Student Type
                </label>
              ...
              <div className="flex flex-col">
                <label htmlFor="password" className="text-sm sm:text-base font-normal text-[#8B0000] mb-2">
                  Enter password
                </label>
                <input
                  id="password"
              ...
              <div className="flex flex-col">
                <label htmlFor="confirmPassword" className="text-sm sm:text-base font-normal text-[#8B0000] mb-2">
                  Re-enter password
                </label>
                <input
                  id="confirmPassword"
