  ...
  return (
    <>
      ...
      <main>
        ...
        >
          <h1 className="font-bold text-[#ffdf00] text-4xl sm:text-6xl lg:text-5xl">About iFinder</h1>

          <div className="flex flex-col min-[1745px]:flex-row items-center gap-14 min-[1745px]:gap-8">
            <AboutCard icon="/bell.png" bgColor="#d28f8f" fontColor="#371111" title="Access your class information easily" description="All your essential class details, simplified." />
            <AboutCard icon="/folder_structure.png" bgColor="#ffdf00" fontColor="#800000" title="Classroom links in one website" description="No more searching for the right class link." />
            <AboutCard icon="/book.png" bgColor="#371111" fontColor="#ffdf00" title="Get notified on subject updates" description="Subject information is updated in real time." />
          </div>
