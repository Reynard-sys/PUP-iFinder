      ...
      <div className="space-y-6">
        <div className="flex gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-600 text-sm sm:text-base">{subjectData.schedule}</p>
          </div>
        </div>
          ...
          <div className="flex-1">
            ...
            {isEditing ? (
              <>
                <input
                  type="text"
                  value={subjectData.faculty.name}
                  onChange={(e) => onFieldChange('faculty.name', e.target.value)}
                ...
                <input
                  type="email"
                  value={subjectData.faculty.email}
                  onChange={(e) => onFieldChange('faculty.email', e.target.value)}
              ...
              <>
                <p className="text-gray-900 text-sm sm:text-base">{subjectData.faculty.name}</p>
                <p className="text-gray-600 text-sm sm:text-base">{subjectData.faculty.email}</p>
              </>
            )}
          </div>
        </div>
        ...
        <div className="flex gap-4">
          ...
          <div className="flex-1">
            <h3 className="font-semibold text-gray-900 mb-2">Block Representative</h3>
            {isEditing ? (
              <>
                <input
                  type="text"
                  value={subjectData.blockRep.name}
                  onChange={(e) => onFieldChange('blockRep.name', e.target.value)}
                  className="w-full px-4 py-2.5 border-2 border-gray-300 rounded-lg mb-2 text-sm sm:text-base text-gray-900 placeholder:text-gray-400 focus:border-[#800000] focus:outline-none bg-gray-50"
                ...
                <input
                  ...
                  onChange={(e) => onFieldChange('blockRep.email', e.target.value)}
                  className="w-full px-4 py-2.5 border-2 border-gray-300 rounded-lg text-sm sm:text-base text-gray-900 placeholder:text-gray-400 focus:border-[#800000] focus:outline-none bg-gray-50"
              ...
              <>
                <p className="text-gray-900 text-sm sm:text-base">{subjectData.blockRep.name}</p>
                <p className="text-gray-600 text-sm sm:text-base">{subjectData.blockRep.email}</p>
              </>
            )}
          </div>
        </div>
